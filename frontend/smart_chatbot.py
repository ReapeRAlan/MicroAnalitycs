"""
Chatbot Frontend Mejorado - Sin Ollama
======================================

Interfaz de chatbot inteligente que se conecta al backend
y proporciona respuestas automáticas usando la base de datos.
"""
...
class SmartChatbot:
    """Chatbot inteligente sin Ollama"""
...
💡 **Tip:** El chatbot usa tu base de datos real para respuestas precisas."""
    ...
    def render_chat_interface(self):
        ...
        st.title("🤖 MicroAnalytics - Chatbot Inteligente")
    ...
    def render_sidebar(self):
        """Renderizar barra lateral con información y controles"""
        st.sidebar.header("🤖 Chat Inteligente")
    ...
    def run(self):
        ...
        if not st.session_state.chat_messages:
            welcome_message = {
                "role": "assistant",
                "content": """¡Bienvenido al Chatbot de MicroAnalytics! 🤖

Soy tu asistente inteligente para análisis de negocio. Puedo ayudarte con:
...
💡 **Tip:** Puedes usar comandos en lenguaje natural. ¡Pregúntame lo que necesites!

Para empezar, puedes escribir `ayuda` o usar los botones de la barra lateral.""",
                "timestamp": datetime.now(),
